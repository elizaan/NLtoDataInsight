...
class ConversationContext:
    ...
    def get_context_summary(
        ...
        summary_lines.extend([
            ...
            "For example, if a previous query found max temperature=30.5°C, you can use that value.",
            "If the user asks 'when was it?' or 'where was it?', check if previous queries contain that information."
        ])
