...
# x_range = [int(a.x_max*0.057), int(a.x_max*0.174)]
# y_range = [int(a.y_max*0.69), int(a.y_max*0.802)]
...
meshType = "streamline"
world_bbx_len = 10
# cam = [-10, -2, 17, 0.56,0.42, -0.71, -0.7, 0.43, -0.46] # camera params, pos, dir, up
